<div class="flex flex-col gap-4">
   ...
   <div>
      ...
      <input type="text" id="genre-new" placeholder="Escribe el nuevo género"
   ...
   <div>
      ...
      <textarea name="synopsis" rows="5"
         class="w-full border border-gray-300 rounded px-3 py-2 text-sm focus:outline-none focus:ring-2 focus:ring-[#004d42]">{{ old('synopsis', $libro->synopsis ?? '') }}</textarea>
