...
<head>
   ...
   <title>Cloudbook: Nuevo Género</title>
...
<body>
   ...
   <div class="max-w-7xl mx-auto">
      <x-breadcrumbs :breadcrumbs="[
         ...
         ['label' => 'Nuevo género', 'url' => route('admin.genres.create')],
      ]"/>
   </div>

   <section class="max-w-4xl mx-auto mt-5 mb-20">
      <form method="POST" action="{{ route('admin.genres.store') }}" enctype="multipart/form-data" onsubmit="resolveGenre()">
         @csrf
         <div class="flex justify-between items-center mb-5">
            <h1 class="text-2xl font-bold text-[#004d42]">Añadir género</h1>
